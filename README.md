...
- **Hear it and keep it**: `audio` lists the sound inputs on this computer, `audio feed` plays the scanner through one, and `audio record` writes a file per transmission with a description beside it.
